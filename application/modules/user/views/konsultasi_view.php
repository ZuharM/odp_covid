	...
	<section class="content">
		...
		<div class="row">
				...
				<div class="box box-primary">
					...
					<div class="box-body"> 
						...
						if($result['persentase'] >= 98){
							$tampilkan = ' Gejala Klinis saat ini Sedang ';
						} elseif ($result['persentase'] >= 90) {
							$tampilkan = ' Gejala Klinis saat ini Minimal ';
						} elseif ($result['persentase'] >= 50) {
							$tampilkan = ' Gejala Klinis Covid-19 saat ini tidak Ada ';
						} else {
							$tampilkan = ' Gejala Klinis Covid-19 saat ini tidak Ada ';
						}
						echo $tampilkan;
			...
			<div class="col-md-4">
				...
				<a href="<?= base_url('user/konsultasis/uuid/'.$result['uuid']); ?>" class="btn btn-block btn-danger btn-lg"><i class="fa fa-fw fa-heartbeat"></i> Lanjutkan Konsultasi ke-<?= $result['konsultasi']; ?> <i class="fa fa-arrow-circle-right"></i></a>
				</div>
			</div>
		</div>
